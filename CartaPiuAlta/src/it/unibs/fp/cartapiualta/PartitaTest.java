...
public class PartitaTest {
	...
	public void scommessaVinta() {
		...
		Carta cUtente = new Carta(SemiFrancesi.PICCHE, ValoreCarteFrancesi.ASSO);
		Carta cPC = new Carta(SemiFrancesi.PICCHE, ValoreCarteFrancesi.DUE);
	...
	public void scommessaPersa() {
		Partita p = new Partita("Player", 15);
		Carta cUtente = new Carta(SemiFrancesi.PICCHE, ValoreCarteFrancesi.DUE);
		Carta cPC = new Carta(SemiFrancesi.PICCHE, ValoreCarteFrancesi.ASSO);
		p.scommetti(15, cUtente, cPC);
